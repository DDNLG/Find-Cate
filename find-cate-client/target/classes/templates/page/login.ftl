		...
		<script type="text/javascript">
            $(document).ready(function(){
                ...
                $("#login").click(function(){
                    $.ajax({url:"http://localhost:12344/user/login",
                        // dataType:"json",
							type: 'post',
                        ...
                        ,success:function(data){
							var json = eval(data);
							$(location).attr('href', '/user/afterlogin?jwtToken='+json.token);
                        },
                        error:function () {
                            $("#div1").show();
                        }
				...
				<div class="col-md-4 col-md-offset-4">
					...
					<form  class="fh5co-form animate-box" data-animate-effect="fadeIn" onsubmit="return false">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="user_name" name="user_name" placeholder="邮箱" autocomplete="off">
						</div>
						<div class="form-group">
